		...
		private static void Main(string [] args)
		{
			if( args.Length != 0 ){
				...
				if( ( args.Length<=3 ) && ( (args[0]=="-g") || (args[0]=="-gen") || (args[0]=="generate")) ){
					...
					if( args.Length==2 && args[1].EndsWith(".rkf"))		{	pub = args[1].Replace(".rkf", "") + "_public.rkf";	}	//save by generated filename, near privkey
					else if( args.Length==3 )	{	pub = args[2];	}																//save by specified pathway
